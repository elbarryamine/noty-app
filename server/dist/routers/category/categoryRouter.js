...
exports.categoryRouter = trpc_1.default.router({
    getById: withUserProcedure.input(categoryFind).query(async ({ ctx, input }) => {
        try {
            ...
            throw new server_1.TRPCError({
                ...
                message: e instanceof server_1.TRPCError ? e.message : 'could not get user categorys',
                cause: e,
            });
        }
    }),
    ...
    create: withUserProcedure.input(categoryInput).mutation(async ({ ctx, input }) => {
        try {
            ...
            throw new server_1.TRPCError({
                code: e instanceof server_1.TRPCError ? e.code : 'INTERNAL_SERVER_ERROR',
                message: e instanceof server_1.TRPCError ? e.message : 'could not create categorys',
                cause: e,
            });
        }
    }),
